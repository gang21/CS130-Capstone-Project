...
const options = {
  definition: {
    ...
    info: {
      ...
      version: '1.0.0',
      description: 'Documentation for the API endpoints and their expected inputs/outputs.',
    },
    components: {
      schemas: {
        User: {
          ...
          required: ['_id', 'email', 'password', 'sub', 'username', 'graduated', 'overallScore'],
        },
        ...
        Email: {
            ...
            properties: {
              ...
              category: {
                type: 'string',
                description: 'Category associated with the email (e.g., online_shopping, social)'
              },
              feedback: {
                type: 'string',
                description: 'Feedback about the email, if any (e.g., reason for scam flag)'
              },
              emailSender: {
                type: 'string',
          ...
          Text: {
            ...
            properties: {
              ...
              category: {
                type: 'string',
                description: 'Category associated with the message (e.g., online_shopping, social)'
              },
              feedback: {
                type: 'string',
                description: 'Feedback about the email, if any (e.g., reason for scam flag)'
